    ...
    HashMap::from([
        ...
        (
            ...
            location(
                ...
                "Kakariko Village",
                vec![],
                vec![edge!(HyruleField), edge!(CuccoHouseRear)]
            ),
        ),
        (
            CuccoHouseRear,
        ...
        (
            ...
            location(
                ...
                "Eastern Ruins",
                vec![],
                vec![edge!(EasternRuinsUpper), edge!(HyruleField)]
            ),
        ),
        (
            ZoraDomain,
        ...
        (
            ...
            location(
                "Spectacle Rock Cave Right",
                "Death Mountain",
                None,
                vec![edge!(DeathMountainWestTop)]
            ),
        ),
        (
        ...
        (
            ...
            location(
                ...
                "Death Mountain",
                vec![],
                vec![edge!(RossosOreMine), edge!(FireCaveTop)]
            ),
        ),
        (
            BoulderingLedgeLeft,
